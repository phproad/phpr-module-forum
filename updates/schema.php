...
$table = Db_Structure::table("channel_group");
	...
	$table->key(array("channelId", "groupId"), "primary")
	$table->save();

// Conversation table.
$table = Db_Structure::table("conversation", "MyISAM");
	...
	$table->key(array("sticky", "lastPostTime")) // for the ordering of results
...
// Member table.
$table = Db_Structure::table("member", "MyISAM");
	$table->column("memberId", "int(11) unsigned", false)
...
$table = Db_Structure::table("member_channel");
	...
	$table->key(array("memberId", "channelId"), "primary")
	$table->save();

// Member-conversation table.
$table = Db_Structure::table("member_conversation");
	$table->column("conversationId", "int(11) unsigned", false)
	$table->column("type", "enum('member','group')", "member")
	$table->column("id", "int(11)", false)
	...
	$table->key(array("conversationId", "type", "id"), "primary")
	$table->key(array("type", "id"))
	$table->save();
...
$table = Db_Structure::table("member_member");
	$table->column("memberId1", "int(11) unsigned", false)
	$table->column("memberId2", "int(11) unsigned", false)
	$table->key(array("memberId1", "memberId2"), "primary")
	$table->save();

// Post table.
$table = Db_Structure::table("post", "MyISAM");
	$table->column("postId", "int(11) unsigned", false)
	$table->column("conversationId", "int(11) unsigned", false)
	$table->column("memberId", "int(11) unsigned", false)
...
$table = Db_Structure::table("search");
	...
	$table->column("time", "int(11) unsigned", false)
	$table->key(array("type", "ip"))
	$table->save();

// Cookie table.
$table = Db_Structure::table("cookie");
	$table->column("memberId", "int(11) unsigned", false)
	$table->column("series", "char(32)", false)
	$table->column("token", "char(32)", false)
	$table->key(array("memberId", "series"), "primary")
	$table->save();